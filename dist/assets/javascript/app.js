...
// Components
var ClickTrail = React.createClass({displayName: "ClickTrail",
    ...
    render: function() {
        ...
        if(this.props.lastEvent) {
            ...
            return (
                React.createElement("div", {className: "click-trail", style:  clickTrailPos })
            );
        } else {
            return null;
        }
...
var TouchyTouchyUI = React.createClass({displayName: "TouchyTouchyUI",
    ...
    render: function() {
        ...
        return (
            React.createElement("div", {className: "AppInterface", onClick:  this.handleClick, style: { backgroundColor: colorScheme}}, 
                React.createElement(ClickTrail, {lastEvent:  lastEvent }), 
                React.createElement("div", {className: "container titles"}, 
                    React.createElement("h1", null, "Touchy", React.createElement("span", {className: "inner-copy"}, "Touchy")), 
                    React.createElement("h2", null, "Give your screen a tap!")
                ), 
                React.createElement("div", {className: "dev-resources"}, 
                    React.createElement("span", {className: "title"}, "Made with love and..."), 
                    React.createElement("ul", {className: "list reset"}, 
                        React.createElement("li", {className: "javascript"}, 
                            React.createElement("a", {href: "#"}, 
                                React.createElement("img", {src: "dist/assets/images/resource-js.jpg"})
                            )
                        ), 
                        React.createElement("li", {className: "react"}, 
                            React.createElement("a", {href: "http://facebook.github.io/react/", target: "_blank"}, 
                                React.createElement("img", {src: "dist/assets/images/resource-react.jpg"})
                            )
                        ), 
                        React.createElement("li", {className: "sass"}, 
                            React.createElement("a", {href: "http://sass-lang.com/", target: "_blank"}, 
                                React.createElement("img", {src: "dist/assets/images/resource-sass.jpg"})
                            )
                        ), 
                        React.createElement("li", {className: "gulp"}, 
                            React.createElement("a", {href: "http://gulpjs.com/", target: "_blank"}, 
                                React.createElement("img", {src: "dist/assets/images/resource-gulp.jpg"})
                            )
                        )
                    )
                )
...
// Kickoff
React.render(
  React.createElement(TouchyTouchyUI, null),
